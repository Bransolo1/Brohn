...
try{
  authority('before');await start();browser=await chromium.launch({channel:runtime.chrome_channel,headless:true});const context=await browser.newContext({viewport:{width:1440,height:1080}});
