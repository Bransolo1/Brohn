/* TEST CANDIDATE ONLY: preferred prefix with unchanged complete-event hard limits. Not loaded by the participant UI. */
(() => {
  'use strict';
  ...
  globalThis.BrohnEventBatchPreferredCandidate = Object.freeze({select, MAX_BYTES, MAX_EVENTS});
})();
