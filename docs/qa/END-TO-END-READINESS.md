# Brohn end-to-end release gates

Owner instruction, 20 September 2026: continue to a finished premium research
platform capable of competing with iMotions. Historical iMotions release posts
and official YouTube demonstrations must be consulted before sign-off. The master
architecture and all 50 registered capabilities remain the intended scope.

Readiness is measured through complete observable workflows. A package being
installed, a polished menu or a component assertion is not an enabled capability.
...
| Study authoring and delivery | Blank/template/sample/clone/import through frozen participant sequence, questions/tasks, collection and recovery | Many scoped journeys accepted; guided overview/preview and welcome/image journeys now accepted |
| Recording and synchronization | Named input profiles, truthful clocks/markers/gaps, usable quality checks, restart and immutable preservation | Local/replay routes exercised; manager-owned large publication,15-family monitoring, five-second previews and reviewed source criteria accepted; reusable setups and actual device qualification pending |
| Review and annotations | Linked replay, reusable event/interval/AOI annotations, exact source and clock identities, no invented synchronization | Existing signal/gaze explorers accepted; saved versioned intervals/full-data comparisons accepted; synchronized review and reusable cross-recording annotations open |
...
All gates must identify their tested input origin, runtime, evidence file and
limits. Physical-device and human-usability results require actual observations.
