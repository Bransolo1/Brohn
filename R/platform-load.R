brohn_load <- function(envir = parent.frame(), ui = TRUE) {
  ...
  platform <- c("core", "welcome", "question-flow", "analysis-plan", "store", "publication", "methods", "library", "catalog", "delivery", "portability", "analysis", "gaze", "vision", "neural", "eda-events", "headers", "physiology-artifacts", "signal", "multimodal", "jobs", "runtime")
  ...
  platform <- c(platform, "signal-annotations", "signal-reuse")
