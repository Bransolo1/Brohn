brohn_load <- function(envir = parent.frame(), ui = TRUE) {
  ...
  platform <- c(platform, "media-review", "facial-review")
  ...
  if (ui) source("R/platform-media-review-views.R", local = envir, encoding = "UTF-8")
  ...
  if (ui) source("R/platform-gnat-views.R", local = envir, encoding = "UTF-8")
  if (ui) source("R/platform-facial-expression-views.R", local = envir, encoding = "UTF-8")
  if (ui) source("R/platform-facial-review-views.R", local = envir, encoding = "UTF-8")
